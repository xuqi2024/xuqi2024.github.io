...
- C++
- C++20
description: "STL 算法 + Ranges 视图 = 代码即管道，数据流即表达式。"
---
...
| 方向 | 章节 |
|:--|:--|
| ◀ 上一篇 | [（六）Coroutine 协程](/2026/04/23/2026-04-24-cpp20-coroutine/) |
...
7. [（七）Ranges 库](/2026/04/23/2026-04-24-cpp20-ranges/) **← 当前**

</details>

本章讲 C++20 的 Ranges 库（views、actions、pipeline），对比维度：本特性 vs C++17 algorithm 旧写法 vs 其他语言流式数据处理。
