...
- 工具调用
- ReAct
description: "用Agent规划日本5日游，2分钟搞定人工需要2小时的工作。旅行助手Agent的完整实战：工具调用、多步规划、结果验证。"
...
> 本文是《Hello Agents》入门系列第 **13** 章，共 16 章。
...
| **第13章** | **[用Agent规划日本5日游，2分钟搞定2小时的活](/2026/04/16/2026-04-16-hello-agents-ch13-travel-assistant/)** | 👉 当前 |
