...
- 推理
- hello-agents
description: "Agent不是一个新概念，ReAct、CoT、Plan-and-Execute这三种经典范式，决定了你的Agent是思考者还是行动者。想太多绝对是优点——关键是用对思考方式。ReAct适合动态探索，Plan-and-Solve适合结构化任务，Reflection适合精益求精，三种范式各有其战场。"
