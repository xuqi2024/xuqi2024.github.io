...
- Agent框架
- hello-agents
description: "核心结论：学完教程只是开始，真正的能力来自把自己的问题变成Agent的问题——这需要的不是更多技术知识，而是工程判断力：什么时候用Agent，用哪种Agent，怎么评估它够不够好。"
series: hello-agents
...
> 本文是《Hello Agents》开源系列第 **16/16** 章，适合 AI Agent 开发入门到进阶学习。

| 方向 | 章节 |
|:--|:--|
| ◀ 上一章 | [第15章：赛博小镇：25个AI角色自主生活，涌现了什么？](/2026/04/16/2026-04-16-hello-agents-ch15-cyber-town/) |
...
16. [学完16章，现在从0构建你自己的Agent](/2026/04/16/2026-04-16-hello-agents-ch16-graduation/) **← 当前**

</details>

本章是毕业章，从 0 构建自己的 Agent，对比维度：本章路线图 vs 相邻章节的全部内容 vs 业界典型"个人 / 小团队 Agent 项目"组合。

## 对比分析

### 一、本章概念 vs 相邻章节

| 维度 | ch16 毕业章 | ch07 自研框架 | ch08 记忆检索 | ch10 协议 |
|------|-------------|---------------|--------------|----------|
| 抽象层级 | 总览 + 实战 | Runtime | 子系统 | 接口 |
| 关注问题 | "如何从 0 出发" | "如何造轮子" | "如何外挂记忆" | "如何对外通信" |
| 与本章互补 | —— | 提供实现细节 | 提供扩展模块 | 提供外部接入 |

### 二、对比生产中典型组合

| 项目规模 | 推荐组合 | 与本章路径对应 |
|----------|----------|----------------|
| 个人玩具 | LangChain + 本地 LLM | ch06 + ch07 简化 |
| 内部 MVP | LangGraph + Mem0 + MCP | ch08 + ch10 |
| 商业产品 | 微服务编排 + 私有模型 + 自研 Agent 核心 | ch07 + ch11 + ch12 |
| 科研 | smolagents + 自研 RL | ch07 + ch11 |
